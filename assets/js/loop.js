jQuery( function($){
	...
	if( $('.slideshow').length > 0 ) {
		$.supersized({
			...
			slides:  	[				// Slideshow Images
							...
							{image : 'assets/img/sliders/slider2.jpg', title : '<div class="hero-text"><h2 class="hero-heading">PROGRAMMING</h2><p><a href="https://github.com/gaarons"><u>MATLAB Analytics</u></a></p></div>', thumb : '', url : ''},
	...
	if( $('.hero-video').length > 0 ) {
		...
		if( $(window).width() > 480 ) {
			videoOptions.poster = 'assets/img/sliders/slider5.jpg';
		}
